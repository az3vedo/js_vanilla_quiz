...
const quizCotainer   = document.querySelector("#quiz-container");
...
function createQuestion(i) {
  ...
  const questionNumber  = question.querySelector("#question-counter");
...
function hideOrShowQuiz() {
  quizCotainer.classList.toggle("hide");
